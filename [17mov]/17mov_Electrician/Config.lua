...
Config.MinimumCoursesToMedium = 75      -- One course will give player one point. So if Config.MinimumCoursesToMedium = 15, then player will need to make first 15 easy courses
Config.MinimumCoursesToHard = 250      -- Same as above but with hard level :D
...
Config.VehicleDeposit = 300           -- Deposit for the car collected at the time of pulling out, and refunded when returning the car
