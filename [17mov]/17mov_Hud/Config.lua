...
Config.ShowDateIfTimeIsReal = true -- If you set time type to "real" does should also display date?
...
Config.SeatBelts = {
    ...
    BlacklistedModels = { `sultan`, `zentorno` },   -- Enter here models that doesn't have seatbelts. Example: BlacklistedModels = { `sultan`, `zentorno` },
    Warning = true,                                 -- Should play *beep* *beep* when player driving with not fasten belts
    WarningVolume = 20,                             -- Volume of warning sound Scale: <0-100>
    WarningSpeed = 15,                              -- Speed above you will hear a warning
    TogglingSound = true,                           -- Play soung if toggle betls
    TogglingSoundVolume = 20,                       -- Volume of toggling sound
    TogglingSoundIsGlobal = true,                  -- Every player in nearby should hear sound or only player that toggling?
