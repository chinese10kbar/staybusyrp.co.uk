...
Config.RequiredJob = "lumber"             -- Set to "none" if you dont want to use jobs. If you are using target, you have to set "job" parameter inside every export in target.lua
    ...
    ["chips"] = {
        {
            ...
            pricePerPercent = math.random(60, 120),
            itemRewards = {
                -- {
    ...
    ["logs"] = {
        {
            ...
            targetHeading = 270,
            pricePerLog = math.random(120, 240),
            itemRewards = {
                -- {
                --     item_name = "water_bottle",
                --     chance = 50,
    ...
    ["planks"] = {
        {
            ...
            pricePerPallete = math.random(200, 400),
            itemRewards = {
                -- {
                --     item_name = "water_bottle",
                --     chance = 50,
