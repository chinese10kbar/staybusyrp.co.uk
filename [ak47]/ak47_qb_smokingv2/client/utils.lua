...
function effectJoint()
    ...
    Citizen.Wait(7000)
    SetTimecycleModifierStrength(0.70)
    Citizen.Wait(5000)
...
AddEventHandler('ak47_qb_smokingv2:onsmoke:stardawg_joint', function()
    effectJoint()
end)
...
AddEventHandler('ak47_qb_smokingv2:onvape:cookie_dough', function()
    effectVape()
end)
...
AddEventHandler('ak47_qb_smokingv2:onvape:icey_gummy_bear', function()
    effectVape()
end)

AddEventHandler('ak47_qb_smokingv2:onvape:tutti_fruiti', function()
    effectVape()
end)
