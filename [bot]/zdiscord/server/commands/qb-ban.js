...
module.exports = {
    ...
    run: async (client, interaction, args) => {
        ...
        emit("sb-admin:server:ban", player, time, reason);
        */
        ...
        emit("sb-log:server:CreateLog", "bans", "Player Banned", "red", `${GetPlayerName(args.id)} was banned by ${interaction.member.displayName} for ${args.reason}`, true);
