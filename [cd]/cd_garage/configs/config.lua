...
Config.JobVehicles = {
    ...
    RegularMethod = {
        ...
        ['police'] = {
            [1] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'car', model = `rppolice1`},
            [2] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'car', model = `rpPolice2`},
            [3] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'car', model = `rpPolice3`},
            [4] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'car', model = `rpPolice4`},
            [5] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'car', model = `rpPolice5`},
            [6] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'car', model = `rpPolice6`},
            [7] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'car', model = `rppolice7`},
            [8] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'car', model = `rpPolice8`},
            [9] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'car', model = `rpPolice9`},
            [10] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'car', model = `rpPolice10`},
            [11] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'car', model = `rpPolice11`},
            [12] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'car', model = `rpPolice12`},
            [13] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'car', model = `rpPolice13`},
            [14] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'car', model = `rpPolice14`},
            [15] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'car', model = `rpPolice15`},
            [16] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'car', model = `rpPolice16`},

            -- unmarked

            [17] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'car', model = `rpPoliceUC1`},
            [18] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'car', model = `rpPoliceUC2`},
            [19] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'car', model = `rpPoliceUC3`},
            [20] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'car', model = `rpPoliceUC4`},
            [21] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'car', model = `rpPoliceUC5`},
            [22] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'car', model = `rpPoliceUC6`},
            [23] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'car', model = `rpPoliceUC7`},
            [24] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'car', model = `rpPoliceUC8`},
            [25] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'car', model = `rpPoliceUC9`},
            [26] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'car', model = `rpPoliceUC10`},
            [27] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'car', model = `rpPoliceUC11`},
            [28] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'car', model = `sheriff2`},
            -- riot

            [29] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'car', model = `rpPoliceR1`},
            [30] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'car', model = `rpPoliceR2`},

            -- [15] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'car', model = `gc_focus`},
            -- [1] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'car', model = `sc_235i`},

            [31] = {job = 'police', spawn_max = true, plate = 'SBP', job_grade = 0, garage_type = 'air', model = `rpPoliceH1`},
