...
Config.GarageLocations = { -- IMPORTANT - Every garage name must be unique
  ['Legion Square'] = { -- If you change the name of this garage from Legion Square, you must change the default value of `garage_id` to the same name in the SQL table `players_vehicles`
    coords = vector3(92.09, -1091.3, 29.39),
    spawn = {vector4(89.83, -1094.54, 29.01, 249.6), vector4(88.83, -1096.84, 29.01, 247.94), vector4(87.89, -1099.16, 29.01, 247.39), vector4(86.66, -1101.03, 29.01, 248.91), vector4(86.18, -1103.68, 29.01, 248.66), vector4(85.18, -1105.84, 29.01, 250.02), vector4(84.33, -1108.12, 29.01, 250.25), vector4(83.7, -1110.5, 29.01, 248.34), vector4(83.08, -1112.99, 29.01, 251.23)}, --  you can add multiple spawn locations into a table
    distance = 15,
    type = "car",
    blip = {
      id = 357,
