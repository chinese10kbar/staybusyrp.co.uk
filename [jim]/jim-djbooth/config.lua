...
Config = {
	...
	Locations = {
		{ -- Vanilla Unicorn DJ Booth
			...
			coords = vec3(258.1022, -258.3177, 59.9177), -- Where the booth is located
			soundLoc = vec3(258.1020, -258.3171, 59.9177), -- Add sound origin location if you don't want the music to play from the dj booth
