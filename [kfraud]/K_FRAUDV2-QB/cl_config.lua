...
KonfigCL.FuelDrainTime = 4500 --every seccond to drain fuel from amount
KonfigCL.FuelDrainAmount = -0.4 -- drain
KonfigCL.HackMinigame = true -- set to false to disable datacrack

KonfigCL.PrinterPrintTime = 5000 -- every 0.1 secconds add from amount
KonfigCL.PrinterProgressAddPerTick = 0.8 -- every 0.1 secconds add 1.0

KonfigCL.CloneTime = 6000
KonfigCL.CloneProgressAddPerTick = 0.7
