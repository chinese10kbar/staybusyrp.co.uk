...
Config.Companies.Services = {
    {
        job = "police",
        name = "Met Police",
        icon = "https://preview.redd.it/a-mockup-of-the-potential-new-metropolitan-police-crest-v0-o852wyngoh5a1.png?width=1080&crop=smart&auto=webp&s=9fd3c759badb0f772c8a7c522878a454ee48ba4a",
    ...
    },
    {
        job = "deliveroo",
        name = "Deliveroo",
        icon = "https://th.bing.com/th/id/OIP.HyKImmursRZihrE9tRelVQHaHa?rs=1&pid=ImgDetMain",
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the company
        bossRanks = {}, -- ranks that can manage the company
        location = {
...
Config.PhoneNumber = {}
Config.PhoneNumber.Format = "{11}" -- Don't touch unless you know what you're doing. IMPORTANT: The sum of the numbers needs to be equal to the phone number length + prefix length
...
Config.EmailDomain = "staybusy.com"
...
Config.UploadMethod.Video = "Discord" -- "Fivemanage" or "Discord" or "LBUpload" or "Imgur" or "Custom"
Config.UploadMethod.Image = "Discord" -- "Fivemanage" or "Discord" or "LBUpload" or "Imgur" or "Custom
Config.UploadMethod.Audio = "Discord" -- "Fivemanage" or "Discord" or "LBUpload" or "Custom"
