...
RegisterNetEvent("illenium-appearance:client:migration:load-sb-clothing-skin", function(playerSkin)
    ...
    Citizen.CreateThread(function()
        ...
        TriggerEvent("illenium-appearance:client:migration:load-sb-clothing-clothes", playerSkin, cache.ped)
        SetModelAsNoLongerNeeded(model)
    end)
end)

RegisterNetEvent("illenium-appearance:client:migration:load-sb-clothing-clothes", function(playerSkin, ped)
    ...
    TriggerServerEvent("illenium-appearance:server:migrate-sb-clothing-skin", playerSkin.citizenid, appearance)
end)
