...
QBShared.Items = {
  ...
  ['weapon_paintball']          = {['name'] = 'weapon_paintball',              ['label'] = 'Paintball Gun',             ['weight'] = 1000,         ['type'] = 'weapon',     ['ammotype'] = nil,                        ['image'] = 'weapon_paintball.png', ['unique'] = true,         ['useable'] = true,     ['description'] = 'Paintball gun'},
    ...
    -- Communication --
    phone                        = { name = 'phone', label = 'Phone', weight = 700, type = 'item', image = 'black_phone.png', unique = true, useable = true, shouldClose = false, combinable = nil, description = 'Neat phone ya got there' },
