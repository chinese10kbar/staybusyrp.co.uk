# sb-apartments
Apartments System for sb-Core Framework :office:
...
- [sb-clothing](https://github.com/qbcore-framework/sb-clothing) - To save outfits
- [sb-houses](https://github.com/qbcore-framework/sb-houses) - House logic
- [sb-interior](https://github.com/qbcore-framework/sb-interior) - Interior logic
- [sb-weathersync](https://github.com/qbcore-framework/sb-weathersync) - To desync weather while inside
- [sb-spawn](https://github.com/qbcore-framework/sb-spawn) - To spawn the player at apartment if last location was in apartment
...
- Import `sb-apartments.sql` in your database
- Add the following code to your server.cfg/resouces.cfg
```
ensure sb-core
ensure sb-interior
ensure sb-weathersync
ensure sb-clothing
ensure sb-houses
ensure sb-spawn
ensure sb-apartments
```
