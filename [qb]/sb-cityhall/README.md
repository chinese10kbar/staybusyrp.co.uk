# sb-cityhall
City Services for sb-Core Framework

## Dependencies
- [sb-core](https://github.com/qbcore-framework/sb-core)
- [PolyZone](https://github.com/mkafrin/PolyZone) - For Interaction (DrawText and sb-target both require this)
- [sb-target](https://github.com/BerkieBb/sb-target) - For Interaction (Optional)
- [sb-phone](https://github.com/qbcore-framework/sb-phone) - For E-Mail
...
- sb-target integration, this is optional
- PolyZone and sb-core DrawText integration, this is optional
...
![Cityhall sb-target Interaction](https://i.imgur.com/K54cMLt.png)
...
![Driving School sb-target Interaction](https://i.imgur.com/P7jWBsV.png)
