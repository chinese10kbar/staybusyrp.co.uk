...
RegisterNetEvent('sb-core:client:DrawText', function(text, position)
    drawText(text, position)
end)

RegisterNetEvent('sb-core:client:ChangeText', function(text, position)
    changeText(text, position)
end)

RegisterNetEvent('sb-core:client:HideText', function()
    hideText()
end)

RegisterNetEvent('sb-core:client:KeyPressed', function()
    keyPressed()
end)
