...
QBConfig.Money.PayCheckSociety = false                              -- If true paycheck will come from the society account that the player is employed at, requires sb-management
...
QBConfig.Server.Discord = 'https://discord.gg/staybusyrp'                            -- Discord invite link
