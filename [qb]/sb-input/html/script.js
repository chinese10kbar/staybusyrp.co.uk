...
const OpenMenu = (data) => {
    ...
    let form = ["<form id='sb-input-form'>", `<div class="heading">${data.header != null ? data.header : "Form Title"}</div>`];
    ...
    $("#sb-input-form").on("change", function (event) {
    ...
    $("#sb-input-form").on("submit", async function (event) {
        if (event != null) {
