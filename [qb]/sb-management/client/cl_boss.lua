...
RegisterNetEvent('sb-bossmenu:client:OpenMenu', function()
    ...
    local bossMenu = {
        ...
        },
        {
            ...
            params = {
                event = 'sb-bossmenu:client:employeelist',
            }
        },
        {
            ...
            params = {
                event = 'sb-bossmenu:client:HireMenu',
            }
        },
        {
            ...
            params = {
                event = 'sb-bossmenu:client:Stash',
            }
        },
        {
            ...
            params = {
                event = 'sb-bossmenu:client:Wardrobe',
            }
        }
    }
    ...
    exports['sb-menu']:openMenu(bossMenu)
end)

RegisterNetEvent('sb-bossmenu:client:employeelist', function()
    local EmployeesMenu = {
        {
    ...
    QBCore.Functions.TriggerCallback('sb-bossmenu:server:GetEmployees', function(cb)
        for _, v in pairs(cb) do
            EmployeesMenu[#EmployeesMenu + 1] = {
                ...
                params = {
                    event = 'sb-bossmenu:client:ManageEmployee',
                    args = {
                        player = v,
                        work = PlayerJob
                    }
        ...
        EmployeesMenu[#EmployeesMenu + 1] = {
            ...
            icon = 'fa-solid fa-angle-left',
            params = {
                event = 'sb-bossmenu:client:OpenMenu',
            }
        }
        exports['sb-menu']:openMenu(EmployeesMenu)
    end, PlayerJob.name)
end)

RegisterNetEvent('sb-bossmenu:client:ManageEmployee', function(data)
    local EmployeeMenu = {
        {
    ...
    for k, v in pairs(QBCore.Shared.Jobs[data.work.name].grades) do
        EmployeeMenu[#EmployeeMenu + 1] = {
            ...
            params = {
                isServer = true,
                event = 'sb-bossmenu:server:GradeUpdate',
    ...
    EmployeeMenu[#EmployeeMenu + 1] = {
        ...
        params = {
            isServer = true,
            event = 'sb-bossmenu:server:FireEmployee',
    ...
    exports['sb-menu']:openMenu(EmployeeMenu)
end)

RegisterNetEvent('sb-bossmenu:client:Stash', function()
...
RegisterNetEvent('sb-bossmenu:client:Wardrobe', function()
    TriggerEvent('sb-clothing:client:openOutfitMenu')
end)

RegisterNetEvent('sb-bossmenu:client:HireMenu', function()
    local HireMenu = {
        {
    ...
    QBCore.Functions.TriggerCallback('sb-bossmenu:getplayers', function(players)
        for _, v in pairs(players) do
            if v and v ~= PlayerId() then
                HireMenu[#HireMenu + 1] = {
                    ...
                    params = {
                        isServer = true,
                        event = 'sb-bossmenu:server:HireEmployee',
                        args = v.sourceplayer
                    }
                }
            end
        ...
        exports['sb-menu']:openMenu(HireMenu)
    end)
end)
    ...
    if Config.UseTarget then
        for job, zones in pairs(Config.BossMenuZones) do
            for index, data in ipairs(zones) do
                exports['sb-target']:AddBoxZone(job .. '-BossMenu-' .. index, data.coords, data.length, data.width, {
                            ...
                            if #(pos - coords) < 5.0 then
                                ...
                                if #(pos - coords) <= 1.5 then
                                    ...
                                    if not shownBossMenu then
                                        exports['sb-core']:DrawText(Lang:t('drawtext.label'), 'left')
                                        shownBossMenu = true
                                    end
