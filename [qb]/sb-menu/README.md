...
RegisterCommand("qbmenutest", function(source, args, raw)
    openMenu({
        ...
        },
        {
            ...
            params = {
                event = "sb-menu:client:testMenu2",
                args = {
                    number = 1,
                }
            }
...
```
```
RegisterNetEvent('sb-menu:client:testMenu2', function(data)
    ...
    openMenu({
        ...
        },
        {
            ...
            txt = "Other",
            params = {
                event = "sb-menu:client:testButton",
                args = {
...
```
```
RegisterNetEvent('sb-menu:client:testButton', function(data)
