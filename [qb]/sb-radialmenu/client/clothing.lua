...
RegisterNetEvent('sb-radialmenu:ResetClothing', ResetClothing)
...
RegisterNetEvent('sb-radialmenu:ToggleClothing', ToggleClothing)
...
RegisterNetEvent('sb-radialmenu:ToggleProps', ToggleProps)
