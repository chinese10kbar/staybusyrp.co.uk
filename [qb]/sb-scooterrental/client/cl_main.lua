...
CreateThread(function()
    exports['sb-target']:AddTargetModel(Config.PedModel, {
        options = {
            { 
                type = "client",
                event = "sb-scooterrentals:client:ScooterMenu",
                icon = "fas fa-bicycle",
                label = "Rent Scooter",
            },
        },
...
RegisterNetEvent('sb-scooterrentals:client:ScooterMenu', function()
    local ScooterMenu = {
        {
        ...
        },
        {
            ...
            params = {
                event = "sb-scooterrentals:client:Spawn",
                args = {
        ...
        },
		{
            ...
            params = {
                event = "sb-scooterrentals:client:Return",
			}
		},
		{
            header = "< Close",
            params = {
                event = "sb-menu:client:close",
			}
		},
	}
    exports['sb-menu']:openMenu(ScooterMenu)
end)

RegisterNetEvent('sb-scooterrentals:client:Spawn', function(model)
    local model = Config.ScooterModel
    local player = PlayerPedId()
    QBCore.Functions.TriggerCallback('sb-scooterrentals:server:RentCheck', function(CanRent)
        if CanRent then 
...
RegisterNetEvent('sb-scooterrentals:client:Return', function()
