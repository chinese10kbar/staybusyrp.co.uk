...
Citizen.CreateThread(function()
    ...
    LesterFactory.LoadDefault() -- 716.84, -962.05, 31.59
    StripClub.LoadDefault()     -- 99.23 -1291.95 29.27
    ...
    FinanceOffice4.LoadDefault()    -- -1392.667, -480.4736, 72.04217 (Maze Bank West) [Callaghan Tower]
    ...
    -- =---------------------- [DLC: Import/Export] ----------------------=
    -- ====================================================================
    ImportCEOGarage1.LoadDefault()       -- Arcadius Business Centre: -146.6166, -596.6301, 166.0000
    -- ImportCEOGarage2.LoadDefault()       -- Maze Bank Building: -73.9039, -821.6204, 284.0000   /!\ Do not load parts Garage1, Garage2 and Garage3 at the same time (overlaping issues)
    -- ImportCEOGarage3.LoadDefault()       -- Lom Bank: -1576.475, -566.506, 85.500               /!\ Do not load parts Garage1, Garage2 and Garage3 at the same time (overlaping issues)
    -- ImportCEOGarage4.LoadDefault()       -- Maze Bank West: -1391.2450, -473.9638, 77.2000      /!\ Do not load parts Garage1, Garage2 and Garage3 at the same time (overlaping issues)
    ImportVehicleWarehouse.LoadDefault() -- Vehicle warehouse: 994.5925, -3002.594, -39.64699

    -- ====================================================================
    -- =------------------------ [DLC: Gunrunning] -----------------------=
    -- ====================================================================
    GunrunningBunker.LoadDefault()  -- 892.6384, -3245.8664, -98.2645 [Firm Bunker]
    ...
    -- ====================================================================
    DoomsdayFacility.LoadDefault() -- 345.0 4842.0 -60.0 [FIB Building]
	...
	if GetGameBuildNumber() >= 2545 then
        ...
        -- MpSecurityMusicRoofTop.LoadDefault() -- -851.654, -226.964, 60.016
        -- MpSecurityStudio.LoadDefault()       -- -1000.7252, -70.559875, -98.10669
       -- MpSecurityBillboards.LoadDefault()   -- -553.196, 279.345, 90.798
       ...
       -- MpSecurityOffice2.LoadDefault()      -- 383.4156, -59.878227, 108.4595
        ...
        MpSecurityOffice4.LoadDefault()      -- -587.87213, -716.84937, 118.10156-587.87213, -716.84937, 118.10156
    end
end)
...
Citizen.CreateThread(function()
	...
	-- The Music Box
	ActivateInteriorEntitySet(281089,"int01_ba_bar_content")
	ActivateInteriorEntitySet(281089,"int01_ba_booze_03")
	ActivateInteriorEntitySet(281089,"int01_ba_security_upgrade")
	ActivateInteriorEntitySet(281089,"int01_ba_equipment_upgrade")
	ActivateInteriorEntitySet(281089,"int01_ba_equipment_setup")
	ActivateInteriorEntitySet(281089,"int01_ba_dj_keinemusik")
	ActivateInteriorEntitySet(281089,"dj_01_lights_04")
	ActivateInteriorEntitySet(281089,"dj_03_lights_02")
	ActivateInteriorEntitySet(281089,"int01_ba_lightgrid_01")
	RefreshInterior(281089)
end)