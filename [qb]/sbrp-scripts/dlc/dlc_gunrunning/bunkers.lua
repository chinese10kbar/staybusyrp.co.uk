...
GunrunningBunker = {
    ...
    Security = {
        ...
        Set = function(security, refresh)
            ...
            if (security ~= "") then
                SetIplPropState(GunrunningBunker.interiorId, 'standard_security_set', true, refresh)
				SetIplPropState(GunrunningBunker.interiorId, 'security_upgrade', true, refresh)
            else
    ...
    LoadDefault = function()
        ...
        GunrunningBunker.Details.Enable(GunrunningBunker.Details.locker, false)
